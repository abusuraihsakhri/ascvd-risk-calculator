"""
Automated Pytest for ascvd-risk-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    EnrichmentmdEngine,
    LongitudinalRiskTrackingEngine,
    ...
    AscvdriskcalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = AscvdriskcalculatorEnrichmentSuite()
